...
# table = PrettyTable()
# table.field_names=['Regressor','Mean Absolute','Mean Squared','Root Mean Squared','cv Root Mean Squared']
# table.add_row(['Linear Regression',MAE_LR, MSE_LR, RMSE_LR,cvRMSE_LR])
# table.add_row(['Support Vector Regression (std data)',MAE_SVR, MSE_SVR, RMSE_SVR,cvRMSE_SVR])
# table.add_row(['Decision Tree',MAE_DT, MSE_DT, RMSE_DT,cvRMSE_DT])
# table.add_row(['Random Forest',MAE_RF,MSE_RF,RMSE_RF,cvRMSE_RF])
# table.add_row(['Random Forest (std data)',MAE_RF_std,MSE_RF_std,RMSE_RF_std,cvRMSE_RF_std])
# table.add_row(['Gradient Boosting',MAE_GB,MSE_GB,RMSE_GB,cvRMSE_GB])
# table.add_row(['Extreme Gradient Boosting',MAE_XGB,MSE_XGB,RMSE_XGB,cvRMSE_XGB])
# table.add_row(['Bootstrapping',MAE_BT,MSE_BT,RMSE_BT,cvRMSE_BT])
# table.add_row(['Neural Networks',MAE_NN,MSE_NN,RMSE_NN,cvRMSE_NN])
...
def display_timeseries(feature):
    fig = px.line(central_data, x=central_data.index, y=central_data[feature])
...
def render_boxplot(feature):
    fig = px.box(central_data, x = central_data.index.year, y = central_data[feature])
...
def generate_scatter(feature):
    fig = px.scatter(cluster_data, x=feature, y="Power_kW", color="Clusters")
